...
SCRIPT: list[Segment] = [
    ...
    Segment(
        lines=[
            ...
            _cyan("          ╚═════╝  ╚═════╝ ╚═╝  ╚═╝╚═╝  ╚═╝╚═════╝ ", bold=True),
            _l(""),
            _dim("  AI-powered GitLab CI Diagnostics · Gemini 2.0 Flash + MCP"),
    ...
    Segment(
        lines=[
            _l(""),
            _dim("  # Gemini 2.0 Flash decides which MCP tools to call:"),
            _l(""),
    ...
    Segment(
        lines=[
            _l(""),
            _cyan("  How it works", bold=True),
            _l(""),
            _dim("  User / CI Webhook"),
            _dim("        │"),
            _dim("        ▼"),
            _dim("  ┌──────────────────────────────────────────────┐"),
            _cyan("  │   PipelineGuardAgent  (pipelineguard/agent.py)│"),
            _dim("  │   Gemini 2.0 Flash · tool-call loop ≤15 iter │"),
            _dim("  └──────────────────┬───────────────────────────┘"),
            _dim("                     │  MCP function calls"),
            _dim("                     ▼"),
            _dim("  ┌──────────────────────────────────────────────┐"),
            _cyan("  │   @gitlab-org/mcp-gitlab  (official)        │"),
            _dim("  │   list_pipelines · get_pipeline_jobs         │"),
            _dim("  │   get_job_log · create_note (MR comment)     │"),
            _dim("  └──────────────────┬───────────────────────────┘"),
            _dim("                     ▼"),
            _dim("              GitLab REST API"),
            _l(""),
            _dim("  Fallback: --direct flag → python-gitlab (no Node.js needed)"),
        ],
        hold_frames=FPS * 15,
        typing_speed=1,
    ),
